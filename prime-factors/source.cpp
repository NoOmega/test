...
В представленном алгоритме сначала вычисляются все простые числа 
от 1 до квадратного корня из N и записываются в вестор.
Далее каждое натуральное число от 1 до N проходит проверку деления без остатка
на уже вычисленные простые числа меншие или равные квадратному корню из текущего числа.
*/
